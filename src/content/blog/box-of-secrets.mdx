...
1. Split the wire that runs to the lock and triggers the relay. Connect the split end to a WiFi-enabled ESP-32 relay board.
2. Write firmware in Rust to turn the ESP-32 into a Matter client that we can connect to Frank's Apple Home.
