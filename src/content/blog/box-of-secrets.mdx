...
<Figure caption="A diagram of the layout once we added the ESP32." alwaysOneCol={true}>![The inside of the gate at Frank's place, now with more ESP32.](@assets/blog/box-of-secrets/diagram_esp32.png)</Figure>
