...
showDescriptionInPost: true
---

import Figure from "@components/content/Figure.astro";

My friend Frank (not his real name) hosts a lot of guests at his apratment, and his complex's intercom is what ushers them inside. You've probably seen them before, they look like this:

<Figure caption="The Doorking 1834-080 intercom at Frank's apartment." alwaysOneCol={true}>![A Doorking 1834-080 intercom box.](@assets/blog/box-of-secrets/intercom.jpg)</Figure>

Up until recently, guests could find Frank's number in the system, then give it a call. If Frank recognized the people on the line, he would press a number on the dial pad, which the controller would interpret as a signal to unlock the gate.
...
# Help Arrives
My other friend [Hazel](https://fizzyapple12.com) and I arrived to visit Frank during this outage period, and he asked us to see what we could do. Here's what we saw:

<Figure caption="A diagram of what we saw." alwaysOneCol={true}>![The inside of the gate at Frank's place.](@assets/blog/box-of-secrets/diagram.png)</Figure>

We inspected the top box closer, giving a promising result: it was unlocked! The general layout of the box is as follows:

<Figure caption="A diagram of the voice box with wires shown." alwaysOneCol={true}>![A DoorKing 1800-010.](@assets/blog/box-of-secrets/voicebox.webp)</Figure>
...
1. Split the wire that runs to the lock housing and triggers the solenoid. Connect the split end to a Wi-Fi-enabled ESP32 relay board.
2. Write firmware in Rust to turn the ESP32 into a Matter client that we can connect to Frank's Apple Home.
3. Hide the board inside the little junction box, conveniently placed there by the building for maximum discreetness.
4. Power the board by plugging a power cable into the Doorking voice box and running the cable into the junction.

<Figure caption="A diagram of the layou once we added the ESP32." alwaysOneCol={true}>![The inside of the gate at Frank's place, now with more ESP32.](@assets/blog/box-of-secrets/diagram_esp32.png)</Figure>
...
<Figure caption="The gate lock alongside the front door lock in Apple Home." alwaysOneCol={true}>![The gate lock alongside the front door lock in Apple Home.](@assets/blog/box-of-secrets/applehome.png)</Figure>

Fun fact, you can set the manufacturer information to whatever you'd like!

<Figure caption="The manufacturer info we chose." alwaysOneCol={true}>![The manufacturer info we chose.](@assets/blog/box-of-secrets/applehomeinfo.png)</Figure>
...
This was such a fun project to work on, and it allowed me to dip my toes into circuit hacking, something I don’t get to do nearly enough. The components for this project are all super simple, so if you’re in the same position as Frank, give it a try! Tag [me](https://twitter.com/_jack_hogan) on Twitter if you get it working!
