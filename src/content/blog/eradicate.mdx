...
One day in my sophomore year at Purdue, I realized I had made a critical mistake: I had been programming for over a decade up to that point, yet I still didn’t have a website! At the time I didn’t really have much of a brand, so I decided to just throw something together pretty randomly. I looked at one or two sites for inspiration, made a few tiny design tweaks, then settled on a sketch:

[SKETCH HERE]

That turned into this within the span of a few hours:
...
[Show received bytes on old vs new site, literally 100x improvement]
