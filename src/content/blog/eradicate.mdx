...
One day during my sophomore year at Purdue I realized I had made a critical mistake: I had been programming for over a decade up to that point, yet I still didn’t have a website! At the time I didn’t really have much of a brand, so I decided to just throw something together pretty randomly. I looked at one or two sites for inspiration, made a few tiny design tweaks, then settled on a sketch:

<Figure caption="Sketches for my first site.">
    ![The hero page sketch for my first site.](/blog/eradicate/oldSiteSketch.png)
    ![The projects page sketch for my first site.](/blog/eradicate/oldSiteSketch2.png)
</Figure>

I turned those sketches into this within the span of a few hours:

<Figure caption="My first site in all its glory.">
    ![The hero page for my first site.](/blog/eradicate/oldSite.png)
    ![The projects page for my first site.](/blog/eradicate/oldSite2.png)
</Figure>
...
<Figure caption="The sketch for my new site.">
    ![A sketch of my new site.](/blog/eradicate/newSiteSketch.png)
</Figure>
...
<Figure caption="Hazel's message to me.">
    ![A Discord message that says: 💥 :new message: I think I found why your performance is so bad](/blog/eradicate/hazelMsg.png)
</Figure>
...
<Figure caption="The no-cache network traffic on my old versus my new site.">
    ![The network traffic on my old site with a total size of 9,202.03 kB](/blog/eradicate/oldSiteNetwork.png)
    ![The network traffic on my new site with a total size of 101.65 kB](/blog/eradicate/newSiteNetwork.png)
</Figure>
